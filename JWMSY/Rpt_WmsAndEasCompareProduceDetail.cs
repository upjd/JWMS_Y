...
namespace JWMSY
{
    ...
    /// WMS与EAS生产领料对照表
    /// </summary>
    public partial class Rpt_WmsAndEasCompareProduceDetail : Form
    {
        ...
        /// WMS与EAS生产领料对照表
        /// </summary>
        public Rpt_WmsAndEasCompareProduceDetail()
        {
            InitializeComponent();
        }
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var cmd = new SqlCommand("CompareProduceDetail") { CommandType = CommandType.StoredProcedure };
