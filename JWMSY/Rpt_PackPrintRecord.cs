...
namespace JWMSY
{
    ...
    /// 包材标签记录表
    /// </summary>
    public partial class Rpt_PackPrintRecord : Form
    {
        /// <summary>
        /// 包材标签记录表
        /// </summary>
        public Rpt_PackPrintRecord()
        {
            InitializeComponent();
        }

        private void Rpt_PackPrintRecord_Load(object sender, EventArgs e)
        {
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var strTemp = bfun.GetWhereSqlStr("Bar_PackMaterial");
