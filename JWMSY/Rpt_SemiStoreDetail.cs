...
namespace JWMSY
{
    ...
    /// 半成品生产入库记录表
    /// </summary>
    public partial class Rpt_SemiStoreDetail : Form
    {
        /// <summary>
        /// 半成品生产入库记录表构造函数
        /// </summary>
        public Rpt_SemiStoreDetail()
        {
            InitializeComponent();
        }

        private void Rpt_SemiStoreDetail_Load(object sender, EventArgs e)
        {
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var strTemp = bfun.GetWhereSqlStr("Semi_StoreDetail");
