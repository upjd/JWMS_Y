...
namespace JWMSY
{
    ...
    /// 半成品调拨出库记录表
    /// </summary>
    public partial class Rpt_SemiTransferDeliveryDetail : Form
    {
        /// <summary>
        /// 半成品调拨出库记录表构造函数
        /// </summary>
        public Rpt_SemiTransferDeliveryDetail()
        {
            InitializeComponent();
        }

        private void Rpt_SemiTransferDeliveryDetail_Load(object sender, EventArgs e)
        {
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var strTemp = bfun.GetWhereSqlStr("Semi_TransferDeliveryDetail");
