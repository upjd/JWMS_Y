...
namespace JWMSY
{
    ...
    /// 产成品调拨出库记录表
    /// </summary>
    public partial class Rpt_ProOemDetail : Form
    {
        /// <summary>
        /// 产成品调拨出库记录表构造函数
        /// </summary>
        public Rpt_ProOemDetail()
        {
            InitializeComponent();
        }

        private void Rpt_ProTransferDeliveryDetail_Load(object sender, EventArgs e)
        {
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var strTemp = bfun.GetWhereSqlStr("Pro_OemDetail");
