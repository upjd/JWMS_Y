...
namespace JWMSY
{
    ...
    /// 原料档案管理界面
    /// </summary>
    public partial class Base_RawMaterial : Form
    {
        /// <summary>
        /// 选择时， 设置选中的行
        /// </summary>
        ...
        /// 原料档案管理构造函数
        /// </summary>
        /// <param name="bSelect">设置是否是选择功能，还是管理功能</param>
        public Base_RawMaterial(bool bSelect)
        {
            _bSelect = bSelect;
            InitializeComponent();
        }
        ...
        private void GetRawMaterial(bool bTrue)
        {
            ...
            iT_RawMaterialTableAdapter.Fill(dataInventory.IT_RawMaterial, bTrue);
        }
        ...
        private void biSave_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (dataInventory.HasChanges())
            {
                ...
                iT_RawMaterialTableAdapter.Update(dataInventory.IT_RawMaterial);
        ...
        private void uGridRawMaterial_DoubleClick(object sender, EventArgs e)
        {
