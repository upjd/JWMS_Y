...
namespace JWMSY
{
    ...
    /// WMS与EAS完工入库对照表
    /// </summary>
    public partial class Rpt_WmsAndEasCompareWoStore : Form
    {
        /// <summary>
        /// WMS与EAS完工入库对照表
        /// </summary>
        public Rpt_WmsAndEasCompareWoStore()
        {
            InitializeComponent();
        }
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var easData = js.GetManufactureRec(dDate);
            ...
            var cmd = new SqlCommand("CompareWoStore") { CommandType = CommandType.StoredProcedure };
