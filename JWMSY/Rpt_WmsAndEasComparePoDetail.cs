...
namespace JWMSY
{
    ...
    /// WMS与EAS采购数据对照表
    /// </summary>
    public partial class Rpt_WmsAndEasComparePoDetail : Form
    {
        ...
        /// WMS与EAS采购数据对照表
        /// </summary>
        public Rpt_WmsAndEasComparePoDetail()
        {
            InitializeComponent();
        }
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var easData = js.GetPurReceivalDetail(dDate);
            ...
            {
                var cmdInsertTemp =new SqlCommand( "insert into Tmp_Compare(cInvCode,cInvName,iQuantity,cUnit,cGuid) " +
                                    "Values(@cInvCode,@cInvName,@iQuantity,@cUnit,@cGuid)");
            ...
            var cmd =new SqlCommand("ComparePoDetail"){CommandType = CommandType.StoredProcedure};
