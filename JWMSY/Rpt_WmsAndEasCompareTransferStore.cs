...
namespace JWMSY
{
    ...
    /// WMS与EAS采购数据对照表
    /// </summary>
    public partial class Rpt_WmsAndEasCompareTransferStore : Form
    {
        ...
        /// WMS与EAS采购数据对照表
        /// </summary>
        public Rpt_WmsAndEasCompareTransferStore()
        {
            InitializeComponent();
        }
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var easData = js.GetMoveInWarehs(dDate);
            ...
            var cmd = new SqlCommand("CompareTransferStoreNew") { CommandType = CommandType.StoredProcedure };
