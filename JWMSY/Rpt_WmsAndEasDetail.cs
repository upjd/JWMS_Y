...
namespace JWMSY
{
    ...
    /// WMS与EAS接口日志
    /// </summary>
    public partial class Rpt_WmsAndEasDetail : Form
    {
        /// <summary>
        /// WMS与EAS接口日志
        /// </summary>
        public Rpt_WmsAndEasDetail()
        {
            InitializeComponent();
        }

        private void Rpt_WmsAndEasDetail_Load(object sender, EventArgs e)
        {
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var strTemp = bfun.GetWhereSqlStr("Wms_M_Eas");
