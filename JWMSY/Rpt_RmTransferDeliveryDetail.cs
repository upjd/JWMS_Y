...
namespace JWMSY
{
    ...
    /// 原料调拨出库记录表
    /// </summary>
    public partial class Rpt_RmTransferDeliveryDetail : Form
    {
        /// <summary>
        /// 原料调拨出库记录表构造函数
        /// </summary>
        public Rpt_RmTransferDeliveryDetail()
        {
            InitializeComponent();
        }

        private void Rpt_RmTransferDeliveryDetail_Load(object sender, EventArgs e)
        {
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var strTemp = bfun.GetWhereSqlStr("Rm_TransferDeliveryDetail");
