...
namespace JWMSY
{
    ...
    /// 打印箱条码标签界面
    /// </summary>
    public partial class WorkProPrintLabelBox : Form
    {
        /// <summary>
        /// 进行记录跳转用ID
        /// </summary>
        ...
        /// 打印周转箱条码标签界面构造函数
        /// </summary>
        public WorkProPrintLabelBox(string lid)
        {
            _lid = lid;
            InitializeComponent();
        }
        ...
        private void WorkProPrintLabelBox_Load(object sender, EventArgs e)
        {
            ...
            DllWorkPrintLabel.GetTemplet("产成品周转箱标签", ref _cCaption, ref _cPrinter, ref _cTempletPath);
        ...
        {
            using (var st = new Base_Templet(true, "产成品周转箱标签"))
            {
        ...
        private void bbiUpdateBoxLotNo_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            using (var wpbnu = new WorkProductBoxLotNoUpdate())
            {
                wpbnu.ShowDialog();
            }
        }
