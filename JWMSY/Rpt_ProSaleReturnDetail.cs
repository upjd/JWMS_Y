...
namespace JWMSY
{
    ...
    /// 产成品销售退货记录表
    /// </summary>
    public partial class Rpt_ProSaleReturnDetail : Form
    {

        /// <summary>
        /// 产成品销售退货记录表
        /// </summary>
        public Rpt_ProSaleReturnDetail()
        {
            InitializeComponent();
        }

        private void Rpt_ProSaleReturnDetail_Load(object sender, EventArgs e)
        {
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var strTemp = bfun.GetWhereSqlStr("Pro_ReturnDetail");
