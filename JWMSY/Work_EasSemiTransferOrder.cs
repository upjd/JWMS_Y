...
namespace JWMSY
{
    ...
    /// 半成品调拨单打印界面
    /// </summary>
    public partial class Work_EasSemiTransferOrder : Form
    {
        /// <summary>
        /// 调拨单号
        /// </summary>
        ...
        /// 调拨单打印界面的构造函数
        /// </summary>
        public Work_EasSemiTransferOrder()
        {
            InitializeComponent();
        }

        private void Work_EasSemiTransferOrder_Load(object sender, EventArgs e)
        {
            RefreshData();
        }
        /// <summary>
        ...
        private void RefreshData()
        {
            ...
            uGridCheck.DataSource = eo.GetTransfer();
        }
        ...
        public void PrintDialog(string operation)
        {
            ...
            //判断当前打印模版路径是否存在
            var temPath = Application.StartupPath + @"\Stencil\SemiTransferOrder.repx";
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            using (var seq = new SearchEasQuery())
            {
                ...
                uGridCheck.DataSource = eo.GetTransfer2(seq.OrderNumber);
            }
        }
