...
namespace JWMSY
{
    ...
    /// 原料领料记录表
    /// </summary>
    public partial class Rpt_RmDeliveryDetail : Form
    {
        /// <summary>
        /// 原料领料记录表构造函数
        /// </summary>
        public Rpt_RmDeliveryDetail()
        {
            InitializeComponent();
        }

        private void Rpt_RmDeliveryDetail_Load(object sender, EventArgs e)
        {
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var strTemp = bfun.GetWhereSqlStr("Bar_RawMaterial");
