...
namespace JWMSY
{
    ...
    /// 产成品调拨入库记录表
    /// </summary>
    public partial class Rpt_ProTransferStoreDetail : Form
    {

        /// <summary>
        /// 产成品调拨入库记录表
        /// </summary>
        public Rpt_ProTransferStoreDetail()
        {
            InitializeComponent();
        }

        private void Rpt_ProTransferStoreDetail_Load(object sender, EventArgs e)
        {
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var strTemp = bfun.GetWhereSqlStr("Pro_TransferStoreDetail");
