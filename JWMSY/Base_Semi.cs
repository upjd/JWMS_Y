...
namespace JWMSY
{
    ...
    /// 半成品档案的维护界面
    /// </summary>
    public partial class Base_Semi : Form
    {
        ...
        /// 半成品档案界面构造函数
        /// </summary>
        /// <param name="bSelect">设置是否是选择界面还是维护界面</param>
        public Base_Semi(bool bSelect)
        {
            _bSelect = bSelect;
            InitializeComponent();
        }
        ...
        private void GetRawMaterial(bool bTrue)
        {
            ...
            iT_SemiTableAdapter.Fill(dataInventory.IT_Semi, bTrue);
        }
        ...
        private void biSave_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (dataInventory.HasChanges())
            {
                ...
                iT_SemiTableAdapter.Update(dataInventory.IT_Semi);
